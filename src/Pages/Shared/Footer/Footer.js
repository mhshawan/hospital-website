                    ...
                    <Row>
                        <Col md={3} sm={6} xs={12} className='text-start column-gap-responsive'>
                            ...
                            <div className="foot-detail-1">
                                <p>Medina Health Care acquired permission to start a Nursing College in 2011.
                        ...
                        <Col md={3} sm={6} xs={12} className='text-start column-gap-responsive'>
                            ...
                            <ul className="foot-detail-4">
                                <li>{addIcon} Medina arkansas 10004 United states</li>
                                <li>{envIcon} info@medina.com</li>
                                <li>{phnIcon} +123 - 765 - 7645</li>
                            </ul>
                        </Col>
                    </Row>
                </Container>
                <h6 className="pt-5">© Copyright 2021. Made by MH Shawan</h6>
            </footer>
        </>
    );
};
